...
# ubuntu:24.04 ships cmake 3.28 (the wrapper requires >= 3.25) and still
# packages gpac in main, which Debian bookworm dropped.
...
# Bento4 isn't packaged by Debian/Ubuntu — pull the upstream prebuilt SDK.
